...
1. In the command line pane, enter the following command to run the application.
    ...
    **C#**:
    ...
    > **Tip**: If a compilation error occurs because the code targets .NET version 8.0 but .NET 9.0 is installed in the cloud shell, edit the **documentanalysis.csproj** file in the code folder and update the **TargetFramework** setting to **net9.0**.
